...
// var_dump($reserve_member_id);MEMBER_ID,?,

$sql = "INSERT INTO APPOINTMENT (APPTIME, DOCTOR_ID, PET_ID, APP_TYPE_ID, CREATE_DATE, PERIOD) VALUES (?, ?, ?, ?, NOW(), ?)";
...
$statement->bindValue(2 , $reserve_doctor);
$statement->bindValue(3 , $reserve_pet_id);
$statement->bindValue(4 , $reserve_type);
$statement->bindValue(5 , $reserve_datetime);
...
if($reserve_type == '1' || $reserve_type == '2' || $reserve_type == '3' ||$reserve_type == '5'){
   ...
   $sql = "INSERT INTO MEDICAL_RECORDS (TYPE, PET_ID, CREATEDATE, MR_SYMPTOM) VALUES (?, ?, NOW(), ?)";
